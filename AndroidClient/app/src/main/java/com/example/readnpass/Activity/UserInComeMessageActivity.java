...
public class UserInComeMessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_in_come_message);
    ...
    {
        Call<List<BookClaimViewModel>> call =  restService.GetInComeMessageClaim(UserId);
